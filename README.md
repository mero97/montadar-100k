...
git clone https://github.com/montadar97/montadar-100k.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf montadar-100k && rm -rf .telegram-cli && git clone https://github.com/montadar97/montadar-100k.git && cd superflux-bot && ./launch.sh install && ./launch.sh
~~~~~
